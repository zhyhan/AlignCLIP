...
from dassl.dassl.utils.tools import read_image
from dassl.dassl.data.datasets import build_dataset
...
def get_dassl_datasets(dataset_name, root, n_shot=0):
    ...
    #raw_base_dataset = get_raw_dassl_dataset(dataset_name, root, n_shot, "all")
    #raw_open_dataset = get_raw_dassl_dataset(dataset_name, root, n_shot, "all")
